-- =====================================================
-- ADMIN DASHBOARD SYSTEM WITH ORDERS & REVENUE TRACKING
-- =====================================================
-- This script creates tables and views for admin dashboard
-- Includes: Orders summary, Revenue tracking, Statistics
...
CREATE TABLE IF NOT EXISTS admin_activity_log (
  ...
  target_type VARCHAR(50), -- 'order', 'product', 'user', etc.
  target_id UUID,
  details JSONB,
...
-- Insert admin user (phone: 9398601984, password: 9381493260)
-- Note: In production, use proper password hashing
INSERT INTO admin_users (email, phone, password_hash, full_name, role)
VALUES (
  'admin@f1mart.com',
  '9398601984',
  '9381493260', -- In production, hash this with bcrypt
  'F1 Mart Admin',
  'super_admin'
)
...
-- Grant permissions to anon users for public views (if needed)
...
-- All authenticated users can view revenue records (you can restrict this further)
...
DO $$
BEGIN
  RAISE NOTICE '✅ Admin Dashboard System Created Successfully!';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  - create_revenue_record() [Trigger]';
  RAISE NOTICE '';
